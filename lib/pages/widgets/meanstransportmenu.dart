...
class MeansTransportMenu extends StatefulWidget {
  ...
  @override
  MeansTransportMenuState createState() => MeansTransportMenuState();
}

class MeansTransportMenuState extends State<MeansTransportMenu> {
  final List<Map<String, dynamic>> menuItems = [
    {'time': '9 phút', 'icon': Icons.directions_car},
    {'time': '15 phút', 'icon': Icons.directions_bus},
    {'time': '31 phút', 'icon': Icons.directions_walk},
    {'time': '21 phút', 'icon': Icons.directions_bike},
  ];
